...
sudo aptitude install -q -y -f mysql-server mysql-client nginx php5-fpm mc vim curl git-core
...
#nvm alias default $NODEJSVERSION

#echo -e "\n--- Installing javascript components ---\n"
#npm install -g gulp grunt bower > /dev/null 2>&1
